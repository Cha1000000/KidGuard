...
data class DeviceHealth(
    ...
    /**
     * Как завершился ПРЕДЫДУЩИЙ запуск процесса; null — система ничего не помнит.
     *
     * В [isHealthy] намеренно не входит: это диагностика, а не разрешение. Родителю она отвечает на
     * вопрос, которого раньше не было ответа: контроль пропал сам или его остановили — и если
     * остановили, то как именно (кнопкой в настройках, «очистить всё» в диспетчере задач, свайпом).
     */
    val lastExit: ProcessExitRecord? = null,
    /**
     * Блокировка дня, которую телефон уже применил; null — сегодня не блокирован.
     *
