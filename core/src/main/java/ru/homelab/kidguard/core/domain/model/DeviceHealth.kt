...
data class DeviceHealth(
     ...
     *
     * По умолчанию `true`: отчёт сборки, которая про это поле не знает, не должен выглядеть как
     * «защита не настроена». В [isHealthy] не входит — это не разрешение, а ручной шаг настройки,
     * и поднимать по нему тревогу с уведомлениями незачем; родитель видит строку в карточке здоровья.
     */
