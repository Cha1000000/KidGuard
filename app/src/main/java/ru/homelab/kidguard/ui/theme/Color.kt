...
val LightSecondary = Color(0xFF45707E)
val LightSecondaryContainer = Color(0xFFC3DFE8)
val LightOnSecondaryContainer = Color(0xFF0B2E37)
val LightTertiary = Color(0xFF8F6413)
...
// Контуры. Без них Material подставляет свои дефолты (#79747E / #CAC4D0) — серо-фиолетовые,
// чужие нашей бирюзовой палитре: именно ими рисовались рамки Outlined-кнопок в светлой теме.
val LightOutline = Color(0xFF6E8B94)
val LightOutlineVariant = Color(0xFFAEC9D1)
